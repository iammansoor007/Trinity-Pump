...
export default function SettingsEditor({ pageId, data, setData }: { pageId: string, data: any, setData: (d: any) => void }) {
  ...
  useEffect(() => {
    if (data && Object.keys(data).length === 0) {
       setData({
         settings: { siteTitle: "Trinity Pump & Supply", siteTemplate: "%s | Trinity Pump & Supply", favicon: "" },
         navbar: { logo: "", siteTitle: "Trinity Pump & Supply", ctaText: "Contact Us", ctaLink: "/contact-us/", companyLinks: [] },
         footer: { 
           company: { name: "Trinity Pump & Supply", tagline: "Heritage. Integrity. Precision.", description: "", logo: "" },
           ...
           bottom: { copyright: "© 2026 Trinity Pump & Supply", rights: "All Rights Reserved", tagline: "Crafted with Precision", links: [] }
         },
